...
$warna_list = fetchData("SELECT * FROM warna_produk WHERE produk_id = '$produk_id'");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nama) || empty($merek) || empty($harga) || empty($deskripsi)) {
        ...
        if (isset($_FILES['gambar']) && $_FILES['gambar']['size'] > 0) {
            ...
            if (!empty($gambar) && (strpos($gambar, 'assets/uploads/') === 0 || strpos($gambar, 'uploads/') === 0)) {
                deleteImage(basename($gambar));
            }
        ...
        if (empty($error)) {
            // Update produk
            $query = "UPDATE produk SET nama='$nama', merek='$merek', harga='$harga', deskripsi='$deskripsi', gambar='$gambar' 
                      WHERE id = '$produk_id'";
...
<head>
    ...
    <title>Edit Produk - Aster Wear Admin</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10">
                <div class="admin-content">
                    <!-- Header -->
                    <div class="mb-4">
                        <h2 class="fw-bold m-0">Edit Produk</h2>
                        <p class="text-muted small m-0">Update informasi produk: <?php echo $produk['nama']; ?></p>
                    </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="merek" name="merek" value="<?php echo $produk['merek']; ?>" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="6" required><?php echo $produk['deskripsi']; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php if (!empty($produk['gambar'])): ?>
                                        <div class="mb-2">
                                            <?php if (strpos($produk['gambar'], 'http') === 0): ?>
                                                <img src="<?php echo $produk['gambar']; ?>" alt="<?php echo $produk['nama']; ?>" style="max-width: 100%; max-height: 200px; border-radius: 8px;">
                                            <?php else: ?>
                                                <img src="../<?php echo $produk['gambar']; ?>" alt="<?php echo $produk['nama']; ?>" style="max-width: 100%; max-height: 200px; border-radius: 8px;">
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div id="warna-container">
                                        <?php foreach ($warna_list as $warna): ?>
                                            <div class="input-group mb-2">
                                                <input type="text" class="form-control" name="warna[]" placeholder="Masukkan warna" value="<?php echo $warna['warna']; ?>">
